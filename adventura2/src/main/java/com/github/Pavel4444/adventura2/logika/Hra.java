...
public class Hra {
    ...
    public Hra() {
        ...
        platnePrikazy.vlozPrikaz(new PrikazSnez(this.getHerniPlan()));
        platnePrikazy.vlozPrikaz(new PrikazPolit(this.getHerniPlan(),this));
    ...
    public String vratUvitani() {
        return "Vitej!\n" +
        "Jste princ, který se nachází v lese a má za úkol vysvobodit šípkovou růženku, \n" +
        "kterou hlídá čarodejnice ve svém zámku.\n" +
